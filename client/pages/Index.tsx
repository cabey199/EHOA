      ...
      <section className="py-20 bg-primary/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 text-muted-foreground max-w-2xl mx-auto">
            Your contribution helps us promote hiking and camping across Ethiopia. Please share your details, and we'll contact you to discuss how you can support our work.
          </p>
          ...
          {isDonationSubmitted ? (
            <div className="bg-green-100 border border-green-400 text-green-800 p-6 rounded-lg mb-6">
              ...
              <p>We've received your information and will be in touch soon to discuss donation opportunities.</p>
            </div>
          ) : (
            <form onSubmit={handleDonationSubmit} className="bg-white rounded-xl shadow-sm p-8 space-y-6 max-w-2xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="donorName" className="block text-sm font-medium text-foreground mb-2 text-left">
                    Name *
                  </label>
                  <input
                    id="donorName"
                    ...
                    onChange={(e) => handleDonationInputChange('name', e.target.value)}
                    required
                ...
                <div>
                  <label htmlFor="donorEmail" className="block text-sm font-medium text-foreground mb-2 text-left">
                    Email *
                  </label>
                  <input
                    id="donorEmail"
              ...
              <div>
                <label htmlFor="donorPhone" className="block text-sm font-medium text-foreground mb-2 text-left">
                  Phone Number
                </label>
                <input
                  id="donorPhone"
              ...
              <div>
                <label htmlFor="donationMessage" className="block text-sm font-medium text-foreground mb-2 text-left">
                  Donation Interest (Optional)
                </label>
                <textarea
                  id="donationMessage"
                  value={donationFormData.message}
                  onChange={(e) => handleDonationInputChange('message', e.target.value)}
