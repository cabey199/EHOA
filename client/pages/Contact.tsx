  ...
  const faqs = [
    {
      ...
      answer: "Use our Join & Support page to register your interest. We'll connect you with local hiking groups in your area based on your experience level and preferences."
    },
    {
      question: "Can I organize my own hiking event?",
      answer: "Absolutely! EHOA supports both individuals and groups in organizing hiking events. Contact us for guidance on safety protocols, permits, and promotional support."
    },
    {
      question: "Do you provide hiking equipment?",
      answer: "We can help connect you with trusted equipment suppliers and provide recommendations for gear based on your specific hiking plans and budget."
    },
    {
    ...
    },
    {
      ...
      answer: "All our events follow strict safety protocols including trained guides, emergency communication systems, first aid kits, and weather monitoring."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Have questions about EHOA, want to organize a hike, or need support? We're here to help connect you with Ethiopia's hiking community.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            {contactMethods.map((method, index) => (
              <div key={index} className="bg-white rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow duration-200 text-center">
